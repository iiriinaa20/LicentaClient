  ...
  Future<List<Map<String, dynamic>>> fetchFutureCourses() async {
    try {
      ...
      for (var planification in planificationData) {
        if (planification['user_id'] == widget.user.dbUser.id) {
          // if (planification['user_id'] == userData['id']) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
          ...
          user: widget.user,
          title: 'Your next courses: $displayName'),
      body: Column(
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        var courseYear =
                            course['course_year'] ?? 'Unknown Year';
      ...
      bottomNavigationBar: CustomBottomNavigationBar(
          authService: widget.authService, user: widget.user, currentIndex: 2),
    );
  }
}
